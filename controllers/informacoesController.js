...
router.get('/informacoes/:funcionario_id', adminAuth, (request, response) => {
    ...
    database('funcionarios')
        .where('funcionario_id', funcionario_id)
            .first()
                .then((funcionario) => {
                    response.render('funcionarios/informacoes/info', {
                        funcionario: funcionario,
                    });
                });
});

router.post('/informacoes/save', adminAuth, async (request, response) => {
